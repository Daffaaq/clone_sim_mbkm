...
class SMenuSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('s_menu')->upsert([
            ...
            ['menu_id' => '22', 'menu_scope' => 'ALL', 'menu_code' => 'TRANSACTION.INSTRUKTUR', 'menu_name' => 'Instruktur', 'menu_url' => 'transaksi/instruktur', 'menu_level' => '2', 'order_no' => '4', 'parent_id' => '3', 'class_tag' => 'transaksi-persetujuan-kelompok', 'icon' => 'fas fa-minus text-xs', 'is_active' => '1'],
