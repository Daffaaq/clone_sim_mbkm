                        ...
                        @foreach ($data->subKriteria as $subKriteria)
                            <div class="col-sm-8" style="margin-bottom: 8px;">
                                <input type="text" class="form-control form-control-sm" style="width: 136%;"
                                    value="{{ $subKriteria->name_kriteria_pembahas_dosen }}" disabled>
                                <div class="input-group-append">
                                    <a href="#" class="ml-2 cursor-pointer remove-btn"
                                        id="removeBtn_{{ $subKriteria->nilai_pembahas_dosen_id }}"
                                        id="id{{ $subKriteria->nilai_pembahas_dosen_id }}"
                                        data-subcategory-id="{{ $subKriteria->nilai_pembahas_dosen_id }}"
...
<script>
    $(document).ready(function() {
        var baseUrl = "{{ url('category/nilai-pembahas-dosen/') }}";
