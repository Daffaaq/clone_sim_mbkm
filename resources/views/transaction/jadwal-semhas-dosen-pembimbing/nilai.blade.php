<div id="modal-master" class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
        ...
        <form id="form-nilai" action="{{ route('simpan.nilai') }}" method="POST">
                        ...
                        <td>
                            <div class="form-group" style="display: flex;align-items: center;margin-bottom: 10px;">
                                ...
                                <textarea class="form-control" id="saran_pembimbing_dosen" name="saran_pembimbing_dosen" rows="3"
                                    style="flex: 1; width: 590px;"><?php echo isset($existingNilai) ? $existingNilai->saran_pembimbing_dosen : ''; ?></textarea>
                        ...
                        <td>
                            <div class="form-group" style="display: flex;align-items: center;margin-bottom: 10px;">
                                ...
                                <textarea class="form-control" id="catatan_pembimbing_dosen" name="catatan_pembimbing_dosen" rows="3"
                                    style=" flex: 1; width: 590px"><?php echo isset($existingNilai) ? $existingNilai->catatan_pembimbing_dosen : ''; ?></textarea>
                            </div>
                        </td>
                    </tr>
                </table>
