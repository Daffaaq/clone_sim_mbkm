        ...
        <div class="modal-body p-0">
            <div class="header">
                <div class="header-container" style="display: flex;">
                    <h5 style="margin-left: 5px;">EVALUASI AKHIR SEMESTER DOSEN PEMBAHAS</h5>
                    <a href="{{ url('transaksi/ujian-seminar-hasil/' . $encryption . '/cetak-nilai-pembahas') }}"
                ...
                <h5 style="text-align: center">DOSEN PEMBAHAS</h5>
            </div>
                    ...
                    <td>
                        <div class="form-group" style="display: flex;align-items: center;margin-bottom: 10px;">
                            ...
                            <textarea class="form-control" id="saran_pembahas_dosen" name="saran_pembahas_dosen" rows="3"
                                style="flex: 1; width: 590px;" value="" readonly>{{ isset($existingNilai->saran_pembahas_dosen) ? $existingNilai->saran_pembahas_dosen : '' }}</textarea>
                        </div>
                    </td>
                </tr>
                <tr>
                    <td>
                        <div class="form-group" style="display: flex;align-items: center;margin-bottom: 10px;">
                            ...
                            <textarea class="form-control" id="catatan_pembahas_dosen" name="catatan_pembahas_dosen" rows="3"
                                style=" flex: 1; width: 590px" value="" readonly>{{ isset($existingNilai->catatan_pembahas_dosen) ? $existingNilai->catatan_pembahas_dosen : '' }}</textarea>
                        </div>
                    </td>
                </tr>
            </table>
